...
| Assessment engine RPC                                                         | Create/version/share/import/set structure; publish/start/save/submit/grade/release/regrade/finalize. Tất cả kiểm scope, idempotency và actor ở DB; danh sách đầy đủ tại docs/09.                                                                     |
