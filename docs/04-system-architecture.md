...
`enroll_student` · `transfer_enrollment` · `change_enrollment_status` · `bulk_mark_attendance` · `generate_class_sessions` · `publish_assessment_results` · `record_tuition_payment` · `admin_invite_user`
