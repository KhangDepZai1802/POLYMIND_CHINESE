...
2. **Kiểm tra/Thi** — giáo viên tạo bộ đề trên hệ thống, mở kỳ thi trong một khung giờ thuộc cùng một ngày, học viên vào thi bất kỳ lúc nào trong khung cho phép, hệ thống tính thời lượng riêng từ lúc bắt đầu và tự động nộp khi hết giờ.
...
| EX-12 | Giáo viên cấu hình một **khung giờ dự thi nằm trong cùng một ngày** theo múi giờ `Asia/Ho_Chi_Minh`. Học viên được bắt đầu bất kỳ lúc nào trong khung đó. |
...
Phase đầu không cần bucket nộp bài chung vì học viên trả lời trực tiếp. Khi triển khai speaking/video phase sau mới tạo bucket answer media.
...
- AC-EX-030: Opens/closes bắt buộc cùng ngày Việt Nam.
